...
#define STRING_VERSION_CONFIG_H "2013-05-30" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "diegudio" //Who made the changes.
...
#define TEMP_SENSOR_0 1 //extruder 1
#define TEMP_SENSOR_1 0 //extruder 2
#define TEMP_SENSOR_2 0 //extruder 3
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.00,80.00,4000,590.9}  // default steps per unit for ultimaker 
